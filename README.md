# ⛽ Calculadora de Combustível: Gasolina x Etanol
...
Um sistema web prático e eficiente desenvolvido para ajudar os motoristas a descobrirem qual é a opção de combustível mais econômica (Gasolina ou Etanol) no momento do abastecimento, levando em consideração a relação de preço e o rendimento do veículo.
...
* **Frontend:**
  * HTML5
  * CSS3
  * JavaScript (Validações, formatação de moeda e interatividade)
* **Backend:**
  * PHP (Processamento dos dados e lógica de negócio)
